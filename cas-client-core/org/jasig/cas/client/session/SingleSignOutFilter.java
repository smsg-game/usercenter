...
public final class SingleSignOutFilter extends AbstractConfigurationFilter {
	...
	public void init(final FilterConfig filterConfig) throws ServletException {
		...
		handler.init();
		String value = filterConfig.getInitParameter("storyage");
		if (value != null) {
			try {
				Class<SessionMappingStorage> cla = (Class<SessionMappingStorage>) Class
						.forName(value);
				this.setSessionMappingStorage(cla.newInstance());
			} catch (Exception e) {
