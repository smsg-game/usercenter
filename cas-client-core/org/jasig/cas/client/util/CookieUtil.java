...
public class CookieUtil {
	...
	//自动标识
	public static String AUTO_LOGIN_TAG = "a";
	//已登录标识
	public static String ALREADY_LOGIN_TAG = "s";
	//登录后COOKIE值
	public static String LOGIN_STAT_VALUE = "1";
	//未登录的COOKIE值
	public static String UNLOGIN_STAT_VALUE = "0";
