package com.easou.usercenter.jedis;
...
//    private ShardedJedis shardedJedis;
    ...
    public TestPool() {
        ...
        Jedis jedis1 = shardedJedis.getShard("m1");
        jedis1.auth("HG%^&*DF");
...
//        jedis.disconnect();
    ...
    private void initialPool() {
        ...
        jedisPool = new JedisPool(config, "127.0.0.1", 6385);
    }
    ...
    private void initialShardedPool() {
        ...
        shards.add(new JedisShardInfo("127.0.0.1", 6385, "m1"));
