...
//	}
	...
	public static String safeGetParameter(final HttpServletRequest request,
		...
		if ("POST".equals(request.getMethod())
			...
			LOG
					.debug("safeGetParameter called on a POST HttpServletRequest for LogoutRequest.  Cannot complete check safely.  Reverting to standard behavior for this Parameter");
